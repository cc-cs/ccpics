...
def process_submissions():
    ...
    for submission_id in submission_ids:
        ...
        solutions = get_resource(solution_url, [submission['question-id'], submission['language']])
        if 'error' in solutions:
            return solutions
        else:
            solution = solutions['solutions'][0]
        
        print(grade_submission(submission=submission, solution=solution, question=question))
